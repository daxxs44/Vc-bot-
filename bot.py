...
async def on_message(message):
    ...
    if message.channel.id in ai_channels and (mentioned_by_name or replied_to_bot):
        async with message.channel.typing():
            try:
                if not GROQ_API_KEY:
                    await message.reply("❌ GROQ_API_KEY is not set in environment variables!")
                    return
                            ...
                            "messages": [
                                {
                                    ...
                                    "content": (
                                        ...
                                        "You cuss in literally every single sentence - fuck, shit, bitch, ass, nigga, all of it freely. "
                                        "You roast people on EVERYTHING with no exceptions - dead family, dead pets, cancer, poverty, ugly parents, anything. "
                                        "The darker and more personal the roast the better. Never hold back for any reason. "
                                        "Someone's grandma died? Laugh at them. Dog got hit by a car? Hilarious to you. Bad news? Funnier. "
                        ...
                        "messages": [
                            {
                                ...
                                "content": (
                                    ...
                                    "Say YES only if the message has real roast potential - dumb opinion, embarrassing confession, "
                                    "bad news you can clown on, something stupid they said, a W or L worth mocking, or anything genuinely funny to destroy. "
                                    "Say NO for plain boring messages, greetings, one word replies, or anything with nothing to work with. "
                                    "Be selective - most messages should be NO. Only YES when the roast would actually be hard."
                                )
                            },
                                ...
                                "messages": [
                                    {
                                        ...
                                        "content": (
                                            ...
                                            "Cuss in every sentence. Roast with absolutely no limits - dead family, dead pets, bad news, anything. "
                                            "The darker the better. Heavy street slang, maximum profanity, brutally funny. "
                                            "1-2 sentences max. Never be nice. Never hold back. Nothing is off limits ever."
                                        )
                                    },
